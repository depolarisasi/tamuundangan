                    ...
                    <td>
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                            <button class="dropdown-item waves-effect copy-btn" data-text="{{config('settings.wedding_name')}}\n\nAssalamu'alaikum Warahmatullahi Wabarakatuh,\n\nYth. Bpk/Ibu/Sdr/i {{$tamu->tamu_nama}} - {{$tamu->tamu_organisasi}},\n\nDengan memohon rahmat dan ridho Allah SWT, perkenankan kami mengundang Bpk/Ibu/Sdr/i untuk menghadiri acara pernikahan putra-putri kami :\n\n{{config('settings.mempelai_wanita_long')}} & {{config('settings.mempelai_pria_long')}}\n\nYang Insyaallah akan diselenggarakan pada :\n\nHari/Tgl : {{config('settings.resepsi_day')}}, {{config('settings.resepsi_date')}}\nPukul : {{config('settings.resepsi_time')}}\nLokasi : {{config('settings.resepsi_place')}}\n\nMerupakan suatu kehormatan bagi kami apabila Bpk/Ibu/Sdr/i berkenan hadir pada acara pernikahan putra-putri kami pada tautan di bawah ini :\n\n{{url($tamu->tamu_uniquecode)}}\n\nKami juga mengharapkan ucapan dan doa restu Bpk/Ibu/Sdr/i untuk putra-putri kami. Atas perhatiannya kami ucapkan terimakasih.\n\nUnduh E-Invitation:\n{{url($tamu->tamu_qr)}}" ><i class="ti ti-clipboard ti-md"></i> Copy WA</button>
                            <a href="{{url('/'.$tamu->tamu_uniquecode)}}" class="dropdown-item waves-effect"><i class="ti ti-device-floppy ti-md"></i>Link</a>
